...
SCRIPT_2 = "PREDICTOR(F4).py"
SCRIPT_3 = "PREDICTOR(F4)(V02).py"
SCRIPT_4 = "PREDICTOR(F4)(CP1_2).py"
...
btn3 = ctk.CTkButton(
    app,
    text="PREDICTOR F4(V02)", 
    height=60,
    font=("Arial", 18),
    command=lambda: run_script(SCRIPT_3)
)
btn3.pack(pady=20)

btn4 = ctk.CTkButton(
    app,
    text="PREDICTOR(F4)(CP1_2)", 
    height=60,
    font=("Arial", 18),
